...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, AIN2_Pin|BIN1_Pin|BIN2_Pin|CIN1_Pin
                          |CIN2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(PWMC_GPIO_Port, PWMC_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, PWMA_Pin|DIN1_Pin|PWMB_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, LCD_DC_Pin|PWMD_Pin|LED0_Pin|LED1_Pin, GPIO_PIN_RESET);
